...
public class Knight extends Piece{
    ...
    public ImageIcon getImageIcon(){
        if (this.color == Color.Black){
            return new ImageIcon(Objects.requireNonNull(getClass().getResource("/PiecePictures/BKnight.png")));
        }
        else{
            return new ImageIcon(Objects.requireNonNull(getClass().getResource("/PiecePictures/WKnight.png")));
        }
    }
    @Override
    public int getScore(){
